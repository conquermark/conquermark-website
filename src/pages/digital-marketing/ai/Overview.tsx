...
export default function Overview() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Transform Your Business with AI-Powered Solutions"
      heroSubtitle="Unlock growth with cutting-edge AI services that automate workflows, enhance customer experiences, and drive measurable ROI"
      heroStats={[
      ...
      includedTitle="What's Included in Our AI Services Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for AI Services"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven AI Services Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from AI Services"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's AI Services services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      popupOffer="Get your free AI Services audit and custom strategy proposal"
      relatedServices={getRelatedServices("/digital-marketing/ai/overview", "AI").map(s => ({
        name: s.name,
        href: s.href,
