...
export default function DigitalMarketing() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="AI-Powered Digital Marketing That Delivers Results"
      heroSubtitle="Leverage machine learning and predictive analytics to optimize campaigns, personalize messaging, and maximize conversions"
      heroStats={[
      ...
      includedTitle="What's Included in Our AI Digital Marketing Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for AI Digital Marketing"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven AI Digital Marketing Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from AI Digital Marketing"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's AI Digital Marketing services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      faqs={[
        {
          question: "How long does it take to see results from AI Digital Marketing?",
      ...
      serviceName="AI Digital Marketing"
      popupOffer="Get your free AI Digital Marketing audit and custom strategy proposal"
      relatedServices={getRelatedServices("/digital-marketing/ai/digital-marketing", "AI").map(s => ({
        name: s.name,
        href: s.href,
