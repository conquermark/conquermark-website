...
export default function BrandAudit() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Comprehensive Brand Visibility Audit"
      heroSubtitle="Discover how your brand appears across search engines, AI platforms, and social media with our in-depth audit"
      heroStats={[
      ...
      includedTitle="What's Included in Our Brand Visibility Audit Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for Brand Visibility Audit"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven Brand Visibility Audit Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from Brand Visibility Audit"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's Brand Visibility Audit services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      faqs={[
        {
          question: "How long does it take to see results from Brand Visibility Audit?",
      ...
      serviceName="Brand Visibility Audit"
      popupOffer="Get your free Brand Visibility Audit audit and custom strategy proposal"
    />
  );
}
