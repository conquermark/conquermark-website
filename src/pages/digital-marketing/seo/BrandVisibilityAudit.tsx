...
export default function BrandVisibilityAudit() {
  return (
    <ConversionPageTemplate
      heroHeadline="Discover How Your Brand Performs in AI Search Engines"
      heroSubheadline="Get a comprehensive audit of your brand's visibility across ChatGPT, Perplexity, Google SGE, and 9 other AI engines. Includes competitive analysis and actionable recommendations."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/seo-audit"
      heroStats={[
        { label: "AI Engines Audited", value: "12", icon: Search }, { label: "Queries Analyzed", value: "500+", icon: BarChart }, { label: "Audit Delivery", value: "5 Days", icon: Clock }, { label: "Audits Completed", value: "300+", icon: Users }
      ]}
      ...
      painPoints={[
        "You don't know how visible your brand is in AI search", "Competitors might be dominating AI engines in your industry", "You need data to justify GEO investment to leadership", "Your current SEO agency doesn't track AI visibility", "You're flying blind in the fastest-growing search channel"
      ]}
      audienceThoughts={[
        "What will the audit actually tell us?", "How much does a comprehensive audit cost?", "Will we get actionable recommendations or just data?", "Can we implement the recommendations ourselves?", "How often should we audit AI visibility?"
      ]}
      
      solutionHeadline="In-Depth AI Visibility Audit + Strategic Roadmap"
      solutionDescription="Our audit analyzes 500+ queries across 12 AI engines, benchmarks you against competitors, identifies visibility gaps, and provides a prioritized roadmap to improve your AI search presence. Delivered in 5 days with executive presentation included."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/seo/brand-audit", "SEO").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "Brand Visibility Audit", href: "/digital-marketing/seo/BrandVisibilityAudit" }
      ]}
    />
  );
}
