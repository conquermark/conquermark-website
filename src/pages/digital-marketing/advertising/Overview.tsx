...
export default function Overview() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Digital Advertising That Maximizes ROI"
      heroSubtitle="Drive qualified leads and sales with data-driven advertising campaigns across Google, Facebook, LinkedIn, and more"
      heroStats={[
      ...
      includedTitle="What's Included in Our Digital Advertising Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for Digital Advertising"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven Digital Advertising Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from Digital Advertising"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's Digital Advertising services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      popupOffer="Get your free Digital Advertising audit and custom strategy proposal"
      relatedServices={getRelatedServices("/digital-marketing/advertising/overview", "Advertising").map(s => ({
        name: s.name,
        href: s.href,
