...
export default function Programmatic() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Programmatic Advertising & Display Retargeting"
      heroSubtitle="Reach the right audience at the right time with automated bidding and intelligent ad placements"
      heroStats={[
      ...
      includedTitle="What's Included in Our Programmatic Advertising Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for Programmatic Advertising"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven Programmatic Advertising Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from Programmatic Advertising"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's Programmatic Advertising services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      faqs={[
        {
          question: "How long does it take to see results from Programmatic Advertising?",
      ...
      serviceName="Programmatic Advertising"
      popupOffer="Get your free Programmatic Advertising audit and custom strategy proposal"
    />
  );
}
