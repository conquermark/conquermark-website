...
export default function SocialManagement() {
  return (
    <ConversionPageTemplate
      heroHeadline="Social Media Management That Builds Communities and Drives Sales"
      heroSubheadline="Stop posting into the void. Our social media management builds engaged communities, drives website traffic, and generates leads. Average engagement rate: 4.2% (industry avg: 1.1%)."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/content-audit"
      heroStats={[
        { label: "Avg Engagement Rate", value: "4.2%", icon: Users }, { label: "Follower Growth", value: "187%", icon: TrendingUp }, { label: "Accounts Managed", value: "200+", icon: Target }, { label: "Posts Created Monthly", value: "2000+", icon: FileText }
      ]}
      ...
      painPoints={[
        "Your social media posts get little to no engagement", "You don't have time to consistently post quality content", "Your social media doesn't drive traffic or leads", "You're not sure what to post or when to post it", "Managing multiple social platforms is overwhelming"
      ]}
      audienceThoughts={[
        "Is social media management worth the investment?", "How often should we be posting on social media?", "Can social media actually drive business results?", "What's included in social media management?", "How do we measure social media ROI?"
      ]}
      
      solutionHeadline="Full-Service Social Media Management"
      solutionDescription="We handle everything: content strategy, post creation, scheduling, community management, and performance reporting. You get consistent, engaging social media presence across all platforms without lifting a finger."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/content/social-management", "Content").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "Social Media Management", href: "/digital-marketing/content/SocialManagement" }
      ]}
    />
  );
}
