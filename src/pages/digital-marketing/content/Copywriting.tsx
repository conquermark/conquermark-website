...
export default function Copywriting() {
  return (
    <ConversionPageTemplate
      heroHeadline="Conversion Copywriting That Turns Visitors Into Customers"
      heroSubheadline="Your website copy is your 24/7 salesperson. Our conversion copywriting has increased client conversion rates by an average of 34% without changing design."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/content-audit"
      heroStats={[
        { label: "Avg Conversion Lift", value: "34%", icon: TrendingUp }, { label: "Websites Written", value: "300+", icon: FileText }, { label: "Industries Served", value: "20+", icon: Target }, { label: "Client Satisfaction", value: "98%", icon: Users }
      ]}
      ...
      painPoints={[
        "Your website traffic doesn't convert into leads or sales", "Your copy is boring, generic, or too technical", "You don't know how to write compelling value propositions", "Your messaging doesn't resonate with your target audience", "You're too close to your business to write effective copy"
      ]}
      audienceThoughts={[
        "Can better copy really improve conversion rates?", "How much does professional copywriting cost?", "Will the copywriter understand our industry?", "How long does website copywriting take?", "Can we test copy changes before committing?"
      ]}
      
      solutionHeadline="Conversion-Focused Copywriting That Sells"
      solutionDescription="We write website copy that speaks directly to your ideal customers, addresses their pain points, and compels them to take action. Every word is crafted to drive conversions, not just sound clever."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/content/copywriting", "Content").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "Website Copywriting", href: "/digital-marketing/content/Copywriting" }
      ]}
    />
  );
}
