        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80">
              ...
              <li><strong>Functionality Cookies:</strong> These cookies allow the website to remember choices you make and provide enhanced features.</li>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4">3.1 Session Cookies</h3>
            <p className="text-foreground/80 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4">3.2 Persistent Cookies</h3>
            <p className="text-foreground/80 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4">3.3 Third-Party Cookies</h3>
            <p className="text-foreground/80 leading-relaxed">
              We may use third-party services like Google Analytics that place cookies on your device to help us analyze website traffic and improve our services.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">5. Browser Controls</h2>
            <p className="text-foreground/80 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">6. Specific Cookie Information</h2>
