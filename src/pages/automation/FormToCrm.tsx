...
export default function FormToCrm() {
  return (
    <AutomationPageTemplate
      heroTitle="Form-to-CRM Integration Automation"
      heroSubtitle="Seamlessly sync forms to CRM in real-time"
      heroDescription="Automated form submissions to CRM with data enrichment and lead scoring"
      heroImage="/form-crm-automation.svg"
