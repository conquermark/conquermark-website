...
export default function CustomApi() {
  return (
    <AutomationPageTemplate
      heroTitle="Custom API & Webhook Automation"
      heroSubtitle="Build custom integrations for any system"
      heroDescription="Connect any system via custom API and webhook integrations"
      heroImage="/api-automation.svg"
