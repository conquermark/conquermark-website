...
export default function Notifications() {
  return (
    <AutomationPageTemplate
      heroTitle="Slack & Email Notification Automation"
      heroSubtitle="Get instant alerts for important business events"
      heroDescription="Automated notifications via Slack, email, and SMS for key business events"
      heroImage="/notifications-automation.svg"
