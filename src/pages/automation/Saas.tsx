...
import { Rocket, Users, CreditCard, BarChart } from "lucide-react";

export default function Saas() {
  return (
    <AutomationPageTemplate
      heroTitle="SaaS & Tech Startup Automation"
      heroSubtitle="Scale your SaaS operations with automation"
      heroDescription="Automate user onboarding, billing, analytics, and support for your SaaS product"
      heroImage="/saas-automation.svg"
