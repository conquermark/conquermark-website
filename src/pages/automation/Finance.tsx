...
export default function Finance() {
  return (
    <AutomationPageTemplate
      heroTitle="Finance & FinTech Automation"
      heroSubtitle="Secure automation for financial services"
      heroDescription="Automate payments, reconciliation, KYC, and financial reporting with bank-level security"
      heroImage="/finance-automation.svg"
