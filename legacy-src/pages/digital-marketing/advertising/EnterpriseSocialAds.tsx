...
export default function EnterpriseSocialAds() {
  return (
    <ConversionPageTemplate
      heroHeadline="Enterprise Social Media Advertising That Scales to $200K+ Monthly Revenue"
      heroSubheadline="Large-scale social advertising requires sophisticated strategies. We've helped enterprise brands scale from $100K to $200K+ monthly revenue while maintaining profitability."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/advertising-audit"
      heroStats={[
        { label: "Revenue Scaled To", value: "$200K+", icon: DollarSign }, { label: "Enterprise Accounts", value: "40+", icon: Users }, { label: "Avg Budget Growth", value: "2x", icon: TrendingUp }, { label: "Platforms Managed", value: "6+", icon: Target }
      ]}
      ...
      painPoints={[
        "Your social ad performance plateaus as you try to scale", "Managing campaigns across multiple brands is overwhelming", "You need enterprise-level creative production and testing", "Previous agencies couldn't maintain performance at scale", "Coordinating social ads with overall marketing is difficult"
      ]}
      audienceThoughts={[
        "Can we scale social ads without killing profitability?", "How do we manage social advertising across multiple markets?", "What's the investment for enterprise social ads management?", "Do we need a huge creative team for social at scale?", "How do we integrate social ads with our marketing stack?"
      ]}
      
      solutionHeadline="Enterprise Social Advertising Built to Scale"
      solutionDescription="We manage high-budget social campaigns across Facebook, Instagram, LinkedIn, TikTok, and Pinterest. Dedicated creative team, advanced testing frameworks, multi-market coordination, and enterprise reporting included."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/advertising/enterprise-social", "Advertising").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "Enterprise Social Ads", href: "/digital-marketing/advertising/EnterpriseSocialAds" }
      ]}
    />
  );
}
