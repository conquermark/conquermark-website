...
export default function PPC() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Expert PPC Management Services"
      heroSubtitle="Get more clicks, conversions, and revenue from Google Ads and Bing with our proven PPC strategies"
      heroStats={[
      ...
      includedTitle="What's Included in Our PPC Management Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for PPC Management"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven PPC Management Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from PPC Management"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's PPC Management services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      popupOffer="Get your free PPC Management audit and custom strategy proposal"
    />
  );
}
