...
export default function AdvertisingLocalServices() {
  const [contactModalOpen, setContactModalOpen] = useState(false);
  const benefits = ["LSA profile optimization", "Review management and response", "Lead qualification and tracking", "Local market domination"];
        ...
        <div className="container">
          <div className="max-w-4xl">
            <nav className="text-sm mb-6">
              ...
              <span className="mx-2 text-primary-foreground/50">/</span>
              <span className="text-primary-foreground">Google Local Services Ads</span>
            </nav>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
                <Target className="h-6 w-6 text-white" />
              </div>
              <h1 className="text-5xl md:text-6xl font-bold">Google Local Services Ads</h1>
            </div>
            <p className="text-xl text-primary-foreground/90 mb-8 max-w-3xl">Manage LSA accounts, reviews, and local lead generation.</p>
      ...
      <section className="py-16 bg-background">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            ...
            <Link href="/digital-marketing/seo/local">
              <Card className="group hover:shadow-lg transition-all cursor-pointer h-full border hover:border-primary/50">
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors">Local SEO Services</h3>
            ...
            <Link href="/digital-marketing/advertising/social-media">
              <Card className="group hover:shadow-lg transition-all cursor-pointer h-full border hover:border-primary/50">
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors">Social Media Advertising</h3>
                  <div className="flex items-center text-primary font-semibold text-sm group-hover:gap-1 transition-all">
                    Learn More
                    <ArrowRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
                  </div>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left">What are Google Local Services Ads?</AccordionTrigger>
              <AccordionContent className="text-foreground/70">
                Local Services Ads appear at the very top of Google search results with the 'Google Guaranteed' badge. They're pay-per-lead (not per-click) and ideal for service businesses like plumbers, electricians, and lawyers.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger className="text-left">How do you get Google Guaranteed?</AccordionTrigger>
              <AccordionContent className="text-foreground/70">
                We help you complete Google's verification process including license checks, insurance verification, and background checks. This typically takes 1-2 weeks and gives customers confidence in your business.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-left">What's the cost per lead?</AccordionTrigger>
              <AccordionContent className="text-foreground/70">
                Cost per lead varies by industry and location, typically ranging from $15-$100. You only pay when customers contact you directly through the ad, making it highly cost-effective.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger className="text-left">Can you manage reviews?</AccordionTrigger>
              <AccordionContent className="text-foreground/70">
                Yes, we help you generate, monitor, and respond to reviews. Reviews are crucial for Local Services Ads as they directly impact your ad ranking and customer trust.
              </AccordionContent>
            </AccordionItem>
            </Accordion>
          </div>
