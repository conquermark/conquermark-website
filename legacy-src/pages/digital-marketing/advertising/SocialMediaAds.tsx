...
export default function SocialMediaAds() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Social Media Advertising That Converts"
      heroSubtitle="Reach your ideal customers on Facebook, Instagram, LinkedIn, and TikTok with targeted ad campaigns"
      heroStats={[
      ...
      includedTitle="What's Included in Our Social Media Advertising Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for Social Media Advertising"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven Social Media Advertising Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from Social Media Advertising"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's Social Media Advertising services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      popupOffer="Get your free Social Media Advertising audit and custom strategy proposal"
    />
  );
}
