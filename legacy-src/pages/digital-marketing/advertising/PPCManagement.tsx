...
export default function PPCManagement() {
  return (
    <ConversionPageTemplate
      heroHeadline="PPC Management That Delivers 4.5x ROAS on Average"
      heroSubheadline="Stop wasting ad budget on underperforming campaigns. Our PPC experts have managed $50M+ in ad spend and consistently deliver 4-5x ROAS for clients across industries."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/advertising-audit"
      heroStats={[
        { label: "Average ROAS", value: "4.5x", icon: DollarSign }, { label: "Ad Spend Managed", value: "$50M+", icon: TrendingUp }, { label: "Active Campaigns", value: "500+", icon: Target }, { label: "Client Retention", value: "96%", icon: Users }
      ]}
      ...
      painPoints={[
        "Your PPC campaigns lose money instead of making it", "You're spending thousands but can't track actual ROI", "Google Ads is too complex to manage in-house effectively", "Your cost per acquisition keeps increasing", "Previous PPC agencies overpromised and underdelivered"
      ]}
      audienceThoughts={[
        "Can PPC really be profitable for my business?", "How much should I spend on PPC advertising?", "What's a realistic ROAS expectation?", "How do I know if my PPC agency is doing good work?", "Is PPC worth it compared to other marketing channels?"
      ]}
      
      solutionHeadline="Data-Driven PPC That Maximizes Every Dollar"
      solutionDescription="We don't just run ads - we engineer profitable campaigns. Our PPC strategies combine advanced targeting, conversion optimization, and continuous testing to deliver consistent 4-5x ROAS. Full transparency with real-time reporting included."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/advertising/ppc", "Advertising").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "PPC Management", href: "/digital-marketing/advertising/PPCManagement" }
      ]}
    />
  );
}
