...
export default function CTV() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Connected TV & OTT Advertising Services"
      heroSubtitle="Reach cord-cutters and streaming audiences with targeted CTV and OTT advertising campaigns"
      heroStats={[
      ...
      includedTitle="What's Included in Our Connected TV & OTT Advertising Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for Connected TV & OTT Advertising"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven Connected TV & OTT Advertising Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from Connected TV & OTT Advertising"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's Connected TV & OTT Advertising services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      faqs={[
        {
          question: "How long does it take to see results from Connected TV & OTT Advertising?",
      ...
      serviceName="Connected TV & OTT Advertising"
      popupOffer="Get your free Connected TV & OTT Advertising audit and custom strategy proposal"
    />
  );
}
