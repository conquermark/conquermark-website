...
export default function Overview() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Dominate Search Results with Advanced SEO Services"
      heroSubtitle="Increase organic traffic, rankings, and revenue with data-driven SEO strategies that outperform competitors"
      heroStats={[
      ...
      includedTitle="What's Included in Our SEO & Search Visibility Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for SEO & Search Visibility"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven SEO & Search Visibility Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from SEO & Search Visibility"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's SEO & Search Visibility services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      faqs={[
        {
          question: "How long does it take to see results from SEO & Search Visibility?",
      ...
      serviceName="SEO & Search Visibility"
      popupOffer="Get your free SEO & Search Visibility audit and custom strategy proposal"
      relatedServices={getRelatedServices("/digital-marketing/seo/overview", "SEO").map(s => ({
        name: s.name,
        href: s.href,
