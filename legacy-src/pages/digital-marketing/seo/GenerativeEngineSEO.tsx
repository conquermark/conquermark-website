...
export default function GenerativeEngineSEO() {
  return (
    <ConversionPageTemplate
      heroHeadline="Rank #1 in AI Search Engines Like ChatGPT and Perplexity"
      heroSubheadline="Traditional SEO is dead. Generative Engine Optimization (GEO) is how you win in the AI search era. Our GEO strategies have increased AI visibility by 340% for clients."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/seo-audit"
      heroStats={[
        { label: "AI Visibility Boost", value: "340%", icon: TrendingUp }, { label: "Brand Mentions", value: "8x", icon: Users }, { label: "Organic Traffic", value: "+89%", icon: BarChart }, { label: "Success Rate", value: "92%", icon: Award }
      ]}
      ...
      painPoints={[
        "ChatGPT and AI search engines never mention your brand", "Your competitors dominate AI-generated recommendations", "Traditional SEO tactics aren't working for AI search", "You're invisible in the fastest-growing search channel", "Your marketing team doesn't understand GEO"
      ]}
      audienceThoughts={[
        "How is GEO different from regular SEO?", "Can we optimize for AI search engines?", "What's the investment required for GEO?", "How long before we see AI search visibility?", "Is this just another SEO fad?"
      ]}
      
      solutionHeadline="Proven GEO Strategies for the AI Search Era"
      solutionDescription="We've cracked the code on Generative Engine Optimization. Our proprietary methods ensure your brand appears prominently when AI engines answer queries in your industry. Real results from real clients."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/seo/generative-engine", "SEO").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "Generative Engine SEO", href: "/digital-marketing/seo/GenerativeEngineSEO" }
      ]}
    />
  );
}
