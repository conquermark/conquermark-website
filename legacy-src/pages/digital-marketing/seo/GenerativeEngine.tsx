...
export default function GenerativeEngine() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Generative Engine SEO: Get Discovered in AI Search"
      heroSubtitle="Optimize your content for AI-powered search engines like ChatGPT, Perplexity, and Google AI Overviews"
      heroStats={[
      ...
      includedTitle="What's Included in Our Generative Engine SEO Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for Generative Engine SEO"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven Generative Engine SEO Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from Generative Engine SEO"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's Generative Engine SEO services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      faqs={[
        {
          question: "How long does it take to see results from Generative Engine SEO?",
      ...
      serviceName="Generative Engine SEO"
      popupOffer="Get your free Generative Engine SEO audit and custom strategy proposal"
    />
  );
}
