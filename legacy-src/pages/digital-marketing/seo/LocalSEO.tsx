...
export default function LocalSEO() {
  return (
    <ConversionPageTemplate
      heroHeadline="Dominate Local Search and Get More Customers Walking Through Your Door"
      heroSubheadline="Own the map pack and local search results in your area. Our local SEO strategies have helped 200+ local businesses increase foot traffic by 156% and phone calls by 234%."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/seo-audit"
      heroStats={[
        { label: "Foot Traffic Increase", value: "156%", icon: Users }, { label: "Phone Calls Growth", value: "234%", icon: Phone }, { label: "Map Pack Rankings", value: "Top 3", icon: Award }, { label: "Local Clients", value: "200+", icon: MapPin }
      ]}
      ...
      painPoints={[
        "Your competitors show up in the Google Map Pack, you don't", "Potential customers can't find you when searching locally", "Your Google Business Profile is incomplete or unoptimized", "Negative reviews are hurting your local reputation", "You're losing business to competitors with better local visibility"
      ]}
      audienceThoughts={[
        "How important is local SEO for my business?", "Can we rank in the map pack for competitive keywords?", "What's the cost of professional local SEO?", "How long before we see more local customers?", "Can we manage local SEO ourselves?"
      ]}
      
      solutionHeadline="Complete Local SEO That Fills Your Calendar"
      solutionDescription="We optimize your Google Business Profile, build local citations, generate positive reviews, and create location-specific content that ranks. The result? You dominate local search and get a steady stream of nearby customers ready to buy."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/seo/local", "SEO").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "Local SEO", href: "/digital-marketing/seo/LocalSEO" }
      ]}
    />
  );
}
