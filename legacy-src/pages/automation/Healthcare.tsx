...
import { Heart, Shield, Calendar, FileText } from "lucide-react";

export default function Healthcare() {
  return (
    <AutomationPageTemplate
      heroTitle="Healthcare Automation & HIPAA Compliance"
      heroSubtitle="Secure, compliant automation for healthcare"
      heroDescription="HIPAA-compliant patient management, appointment scheduling, and medical record automation"
      heroImage="/healthcare-automation.svg"
