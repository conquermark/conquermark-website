...
import { GraduationCap, BookOpen, Users, CheckSquare } from "lucide-react";

export default function Education() {
  return (
    <AutomationPageTemplate
      heroTitle="Education & LMS Automation"
      heroSubtitle="Automate student enrollment and course management"
      heroDescription="Streamline admissions, grading, course delivery, and student communication"
      heroImage="/education-automation.svg"
