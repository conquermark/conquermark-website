...
import { ShoppingCart, Package, Database, Repeat } from "lucide-react";

export default function OrderSync() {
  return (
    <AutomationPageTemplate
      heroTitle="Order + Inventory Sync Automation"
      heroSubtitle="Real-time order processing and inventory management"
      heroDescription="Automated multi-channel order sync and inventory management across all platforms"
      heroImage="/order-sync-automation.svg"
