...
export default function EnterpriseSocial() {
  return (
    <ServicePageTemplate
      // Hero Section
      heroTitle="Enterprise Social Media Advertising Services"
      heroSubtitle="Scale your social advertising across multiple platforms with AI-powered optimization and creative testing"
      heroStats={[
      ...
      includedTitle="What's Included in Our Enterprise Social Media Ads Services"
      includedFeatures={[
        {
      ...
      // Benefits Section
      benefitsTitle="Why Choose Conquermark for Enterprise Social Media Ads"
      benefits={[
        {
      ...
      // Process Section
      processTitle="Our Proven Enterprise Social Media Ads Process"
      processSteps={[
        {
          number: "01",
      ...
      // Results Section
      resultsTitle="Real Results from Enterprise Social Media Ads"
      results={[
        {
          metric: "287%",
      ...
      resultsTestimonial={{
        quote: "Conquermark's Enterprise Social Media Ads services transformed our business. We saw immediate improvements in our key metrics and continue to see growth month over month.",
        author: "Michael Chen",
      ...
      faqs={[
        {
          question: "How long does it take to see results from Enterprise Social Media Ads?",
      ...
      serviceName="Enterprise Social Media Ads"
      popupOffer="Get your free Enterprise Social Media Ads audit and custom strategy proposal"
    />
  );
}
