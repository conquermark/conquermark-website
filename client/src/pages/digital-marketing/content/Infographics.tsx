...
export default function Infographics() {
  return (
    <ConversionPageTemplate
      heroHeadline="Visual Content That Gets 3x More Shares and Engagement"
      heroSubheadline="Infographics and motion graphics capture attention and simplify complex information. Our visual content gets 3x more shares and engagement than text-only posts."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/content-audit"
      heroStats={[
        { label: "Engagement Increase", value: "3x", icon: TrendingUp }, { label: "Infographics Created", value: "500+", icon: FileText }, { label: "Avg Shares", value: "2.4K", icon: Users }, { label: "Client Retention", value: "89%", icon: Award }
      ]}
      ...
      painPoints={[
        "Your content gets ignored in crowded social feeds", "Complex information is hard to communicate effectively", "You don't have design resources for visual content", "Your content doesn't get shared or go viral", "Text-heavy content doesn't perform on social media"
      ]}
      audienceThoughts={[
        "Are infographics still effective in 2024?", "How much do professional infographics cost?", "Can we create motion graphics in-house?", "What's the ROI of visual content?", "How do we measure infographic performance?"
      ]}
      
      solutionHeadline="Professional Infographics and Motion Graphics"
      solutionDescription="We transform your data, processes, and ideas into stunning visual content that captures attention and drives engagement. From static infographics to animated motion graphics - we make your content impossible to ignore."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/content/infographics", "Content").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "Infographics & Motion Graphics", href: "/digital-marketing/content/Infographics" }
      ]}
    />
  );
}
