...
export default function CTVOTT() {
  return (
    <ConversionPageTemplate
      heroHeadline="CTV and OTT Advertising That Reaches Cord-Cutters"
      heroSubheadline="80% of households now stream TV. Reach them with targeted CTV and OTT advertising on Hulu, Roku, Amazon Fire TV, and more. Average completion rate: 92%."
      heroCTA="Get My Free Audit Report"
      heroCTALink="/content-audit"
      heroStats={[
        { label: "Ad Completion Rate", value: "92%", icon: TrendingUp }, { label: "Households Reached", value: "50M+", icon: Users }, { label: "Platforms Available", value: "15+", icon: Target }, { label: "Avg CTR", value: "1.8%", icon: BarChart }
      ]}
      ...
      painPoints={[
        "Traditional TV advertising is too expensive and unmeasurable", "Your target audience has cut the cord and streams everything", "You can't track ROI from TV advertising", "Your competitors are reaching streaming audiences, you're not", "You don't understand how CTV/OTT advertising works"
      ]}
      audienceThoughts={[
        "What's the difference between CTV and OTT?", "How much does streaming TV advertising cost?", "Can we target specific audiences on streaming platforms?", "How do we measure CTV advertising performance?", "Is CTV advertising worth it for our business?"
      ]}
      
      solutionHeadline="Targeted CTV and OTT Advertising"
      solutionDescription="We place your ads on Hulu, Roku, Amazon Fire TV, and 12+ other streaming platforms. Precise audience targeting, measurable results, and completion rates that crush traditional TV advertising."
      usps={[
      ...
      relatedServices={getRelatedServices("/digital-marketing/content/ctv", "Content").map(s => ({
        name: s.name,
        href: s.href,
      ...
      breadcrumbs={[
        ...
        { label: "CTV & OTT Advertising", href: "/digital-marketing/content/CTVOTT" }
      ]}
    />
  );
}
