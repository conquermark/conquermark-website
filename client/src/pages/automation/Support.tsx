...
export default function Support() {
  return (
    <AutomationPageTemplate
      ...
      problemImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663037453261/IvVbHSznoTUGEQIc.jpg"
        workflowImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663037453261/zvDUDiCopwWfPCUm.jpg"
      benefits={[
        {
