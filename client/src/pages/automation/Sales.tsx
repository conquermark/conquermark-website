...
import { Users, TrendingUp, Zap, Database, Phone, MessageCircle } from "lucide-react";
import { ToolLogos } from '../../components/ToolLogos';

export default function Sales() {
  return (
    <AutomationPageTemplate
        toolLogos={[ToolLogos.Salesforce, ToolLogos.Pipedrive, ToolLogos.Zoho, ToolLogos.Outreach, ToolLogos.HubSpot, ToolLogos.Slack]}
      ...
      heroImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663037453261/zyfpLofYxnLBSFmW.png"
      problemImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663037453261/OiN9ta12P2d1.png"
        workflowImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663037453261/UxVqgIosxhzcpgJk.png"
      ...
      process={[
        {
          ...
          description: "We map your current sales process, identify bottlenecks, and find opportunities where automation can accelerate deal velocity."
        },
        {
          step: 2,
      ...
      useCases={[
        {
          ...
          challenge: "A Bangalore-based real estate company was receiving 200+ leads daily from multiple sources. Manual lead assignment took 2-4 hours, causing 60% of leads to go cold before contact.",
      ...
      ctaSubtitle="AI Sales Automation Services"
