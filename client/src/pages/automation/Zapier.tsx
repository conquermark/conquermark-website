...
import { Zap, Link, Workflow, Filter, Layers, Code } from "lucide-react";
import { ToolLogos } from '../../components/ToolLogos';

export default function Zapier() {
  return (
    <AutomationPageTemplate
        toolLogos={[ToolLogos.Trello, ToolLogos.Asana, ToolLogos.Slack, ToolLogos.Gmail, ToolLogos.GoogleSheets, ToolLogos.Typeform]}
      ...
      heroImage="/zapier-dashboard.jpg"
      workflowImage="/zapier-workflow.png"
      ...
      ctaTitle="Ready to Automate with Zapier?"
      ctaSubtitle="Zapier Automation Consultants"
