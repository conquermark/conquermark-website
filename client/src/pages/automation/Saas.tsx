...
export default function Saas() {
  return (
    <AutomationPageTemplate
      ...
      problemImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663037453261/BMTIuIrCqgNxRyZl.png"
        workflowImage="https://files.manuscdn.com/user_upload_by_module/session_file/310519663037453261/QfhYbSTIrAhEbprx.jpg"
